...
public class MainCarsMap {
public static void main(String[] args) {
	LinkedHashMap<Car,CarOwner> map1 = 
			         new LinkedHashMap<>();
    ...
    printCarsMap(map1);
    Car c11 = new Car("Ford Mustang", 5.0, "GHI789", "Red", 2022);
    boolean res = map1.containsKey(c11);
...
public static void printCarsMap(Map<Car, CarOwner> map)
{
